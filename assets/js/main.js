...
$(document).ready(function () {
    ...
    for(var x=0;x<10;x++) {
        if(x<5) {
            $('#imgCol1').append('<img src="assets/img/grandopening/'+images[x]+'" width="100%" style="margin:8px 0" />');
        } else {
            $('#imgCol2').append('<img src="assets/img/grandopening/'+images[x]+'" width="100%" style="margin:8px 0" />');
        }
    }
